...
//significa que solamente aparecerán datos en el detalle que se correspondan con datos del maestro. Se descarta la posibilidad de
//generar altas en el maestro.
//• Cada elemento del archivo maestro puede no ser modificado, o ser modificado por uno o MÁS registros del detalle.

...
//significa que solamente aparecerán datos en el detalle que se correspondan con datos del maestro. Se descarta la posibilidad de generar altas en el maestro.
...
//El objetivo del procedimiento minimo es determinar el menor de los tres elementos recibidos de cada archivo (para poder retornarlo como el más pequeño)
//y leer otro registro del archivo desde donde provenía ese elemento.

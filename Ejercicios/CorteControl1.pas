...
begin
   assign (inst, 'censo'); //relación del archivo lógico con el físico
   reset (inst); //abro el archivo logico
   leer (inst, regm); //leo un registro del archivo
   ...
   while (ant_prov = regm.provincia) and (ant_partido = regm.partido) do begin
       ...
       leer (inst, regm); //leo otro registro del archivo
   end;
